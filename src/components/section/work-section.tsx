...
function LogoImage({ src, alt, icon }: { src?: string; alt: string; icon?: React.ReactNode }) {
      ...
      {DATA.work.map((work) => (
        ...
        >
          <div className="flex items-center gap-x-3">
            <LogoImage src={work.logoUrl as string | undefined} alt={work.company} icon={work.icon} />
